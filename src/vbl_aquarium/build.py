...
generates JSON schemas to the models/schemas directory and C# classes to the models/csharp directory.
JSON schemas are separated to one model per file under the models/schemas/{module_name} directory.
C# classes for each model are bundled together under models/csharp/{module_name}Models.cs.
